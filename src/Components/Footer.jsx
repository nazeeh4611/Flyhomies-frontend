        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/team" className="text-gray-400 hover:text-white">Founders</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/services/software-development" className="text-gray-400 hover:text-white">Software Development</Link></li>
              <li><Link to="/services/voip" className="text-gray-400 hover:text-white">VoIP Solutions</Link></li>
              <li><Link to="/services/digital-marketing" className="text-gray-400 hover:text-white">Digital Marketing</Link></li>
              <li><Link to="/services/app-development" className="text-gray-400 hover:text-white">Mobile App Development</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3 text-gray-400">
                ...
                <a
                  href="https://www.google.com/maps?q=Iris+Bay+Tower,+Business+Bay,+Dubai,+UAE"
                  target="_blank"
              ...
              <li className="flex items-center gap-2 text-gray-400">
                ...
                <a
                  href="mailto:info@flyhomies.com"
                  className="hover:text-white transition"
                >
                  info@flyhomies.com
                </a>
